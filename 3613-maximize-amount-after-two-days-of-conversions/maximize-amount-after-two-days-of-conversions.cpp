...
public:
    ...
    void bellman(unordered_map<string,
    double>& best, vector<vector<string>>& pairs, 
    vector<double>& rates){
    ...
    double maxAmount(string init, 
    vector<vector<string>>& pairs1, 
    vector<double>& rates1, 
    vector<vector<string>>& pairs2, 
    vector<double>& rates2) {
        // these pairs are like edges bw the nodes / currencies 
        // and the rates are the weights
